...
__all__ = (
    ...
    "Qmi8658AccRange_8g",
    "Qmi8658AccRange_16g",
    "Qmi8658GyrRange_16dps",
    "Qmi8658GyrRange_32dps",
    "Qmi8658GyrRange_64dps",
    "Qmi8658GyrRange_128dps",
    "Qmi8658GyrRange_256dps",
    "Qmi8658GyrRange_512dps",
    "Qmi8658GyrRange_1024dps",
    "Qmi8658GyrRange_2048dps",
    "Qmi8658Acc_Gyr_Odr_8000Hz",
    "Qmi8658Acc_Gyr_Odr_4000Hz",
    "Qmi8658Acc_Gyr_Odr_2000Hz",
    "Qmi8658Acc_Gyr_Odr_1000Hz",
    "Qmi8658Acc_Gyr_Odr_500Hz",
    "Qmi8658Acc_Gyr_Odr_250Hz",
    "Qmi8658Acc_Gyr_Odr_125Hz",
    "Qmi8658Acc_Gyr_Odr_62_5Hz",
    "Qmi8658Acc_Gyr_Odr_31_25Hz",
)
...
class QMI8658:
    def __init__(
        ...
        i2c_bus,
        addr=0x6B,
        AccRange=Qmi8658AccRange_8g,
        GyrRange=Qmi8658GyrRange_2048dps,
        Acc_Gyr_Odr=Qmi8658Acc_Gyr_Odr_500Hz,
    ):
        self._device = i2c_bus
        self._address = addr
        if self._chip_id() != 0x05:
            raise AttributeError("Cannot find a QMI8658")
        self.init(AccRange, GyrRange, Acc_Gyr_Odr)
    ...
    def init(
        ...
        self._wreg(QMI8658_REG_Ctrl9, 0xA2)
        time.sleep(1)
        self._wreg(QMI8658_REG_Ctrl1, 0x60)
        self._wreg(QMI8658_REG_Ctrl7, 0x03)
        self._wreg(QMI8658_REG_Ctrl2, (AccRange << 4) | Acc_Gyr_Odr)  # ACC-500HZ/8G
        self._wreg(
            QMI8658_REG_Ctrl3, (GyrRange << 4) | Acc_Gyr_Odr
        )  # Gyr-500HZ/2048dps
    ...
    def _rreg(self, reg, nbytes=1):
        """Read memory address"""
        return (
            self._device.readfrom_mem(self._address, reg, nbytes)[0]
            if nbytes <= 1
            else self._device.readfrom_mem(self._address, reg, nbytes)[0:nbytes]
        )
    ...
    def get_strength(self):
        _x, _y, _z = self.get_accelerometer()
        return math.sqrt(math.pow(_x, 2) + pow(_y, 2) + pow(_z, 2))

    def get_pitch_roll(self):
        acc_x, acc_y, acc_z = self.get_accelerometer()
